...
function ContactForm() {
  return (
    <FormContainer>
      ...
      <TopInput>
        <UserInput name="name" placeholder="Name" />
        <UserInput name="email" placeholder="Email" />
      </TopInput>
      <UserInput name="subject" placeholder="Subject" />
...
const TopHeader = styled.div`
  ...
  &::before {
    ...
    background-color: rgba(
      ...
      0,
      0.253
    ); /* Changed 'color' to 'background-color' for better clarity */
  ...
  @media screen and (max-width: 528px) {
    ...
    &::before {
      ...
      margin-right: 0.5rem; /* Added margin for better spacing */
    }
    &::after {
      content: "";
      height: 10px;
      ...
      margin-left: 0.5rem; /* Added margin for better spacing */
    }
  }
`;
