...
const ProductListings = () => {
  ...
  const listOfWriteUp = [
    "From minor scratches to major cracks , we specialize in restoring your bumper to its original condition . Our experts technicians use advanced techniques and high-quality materials to ensure seamless repairs , enhancing your vehicles appearance and maintaining it structural intergrity . Trust Us to handle your bumper repair with precision and care",
    ...
    "Give your car a fresh vibrant look with our professional vehicle painting services. weather it is a fully body repaint , color changes , or touch up , we use  top grade paints and precision techniques to achieve a flawless finish. Our work not only enhances your vehicle aesthetics but also protects it from enviromental damage , ensuring lasting beauty. ",
